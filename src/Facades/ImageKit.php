 ...
 * @method static bool deleteImage(string $imageName, string|null $path = null, array|null $sizes = null)
 * @method static int deleteGallery(array $imagesNames, string|null $path = null, array|null $sizes = null)
